...
public class Placement {
    ...
    public static Placement HIGH_PLACEMENT_CONE = new Placement("High Placement Cone", Constants.kProtruderDistanceAtFullRetract + 38.0,283.0);
    ...
    public static Placement FEEDER_STATION_CONE = new Placement("Feeder Station Cone",  Constants.kProtruderDistanceAtFullRetract + 8.0,60.0);
